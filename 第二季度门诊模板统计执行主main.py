...
if __name__ == '__main__':
    ...
    excel_path1 = r"excels\第二季度门诊病人来源.xlsx"
    sheets = ['成都市','四川省','外省']
    sheet1 = u'Sheet1'
    COL = 1
    # 获取数据源数据
    ...
    pv_result = pd.pivot_table(result0,index=['办卡地址省','办卡地址市','办卡地址区县'],values='就诊人次',aggfunc='sum')
    # print(pv_result)
    ...
    pv_result1 = pd.pivot_table(result1, index=['办卡地址省', '办卡地址市'], values='就诊人次',aggfunc='sum')
    ...
    pv_result2 = pd.pivot_table(result2, index=['办卡地址省'], values='就诊人次',aggfunc='sum')
